...
<x-app-layout>
    <div class="max-w-7xl mx-auto px-10 py-12 flex justify-center shadow-sm">

        <div
            class="group flex items-center w-[800px] h-[318px] bg-[#FAEDE4] font-['Robot_Flex'] border-b-2 border-[#E3E3E0] border-600 rounded-md saturate-0 hover:saturate-100 transition-[filter] relative">

            <!-- Foto -->
            <img src="images/2141762018.png" alt="Foto Rendy Septian Pradana"
                class="w-[248px] h-[318px] object-cover rounded-md group-hover:rounded-br-[100px] transition-[border-radius]" />

            <!-- Teks di samping -->
            <div class="ml-12 text-left ">
                <h1
                    class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500 mb-2">
                    Rendy Septian Pradana
                </h1>
                <p class="text-black text-[24px] mb-2">NIM : 2141762018</p>
                <p class="text-black text-[24px]">Dibuat Pada : 29 September 2025</p>
            </div>

            <!-- SVG Panah -->
            <svg class="group-hover:opacity-100 opacity-0 transition-opacity absolute right-4 bottom-4"
